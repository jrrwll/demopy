...
airlines.columns = ["id", "name", "alias", "iata", "icao", "callsign",
                    "country", "active"]
...
def haversine(lon1, lat1, lon2, lat2):
    ...
    lon1, lat1, lon2, lat2 = [float(lon1), float(lat1), float(lon2),
                              float(lat2)]
...
airline_route_lengths = airline_route_lengths.sort_values("length",
                                                          ascending=False)
